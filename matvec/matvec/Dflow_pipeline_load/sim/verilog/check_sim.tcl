...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.tiled_matvec.autotvin_Atile_V_vec_0.dat"
         "c.tiled_matvec.autotvin_Atile_V_vec_1.dat"
         "c.tiled_matvec.autotvin_xtile_V_vec_0.dat"
         "c.tiled_matvec.autotvin_xtile_V_vec_1.dat"
         "c.tiled_matvec.autotvin_ypartial.dat"
         "c.tiled_matvec.autotvin_i2.dat"
         "c.tiled_matvec.autotvout_ypartial.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.tiled_matvec.autotvout_ypartial.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
