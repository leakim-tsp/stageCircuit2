...
int (&i2))
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *ypartial_pc_buffer = new sc_bv<32>[8];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: ypartial
				{
					...
					// {
						...
						// {
							sc_lv<32>* ypartial_lv0_0_7_1 = new sc_lv<32>[8];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: ypartial(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 7; i_0 += 1)
							{
								...
								{
									ypartial_lv0_0_7_1[hls_map_index].range(31, 0) = sc_bv<32>(ypartial_pc_buffer[hls_map_index].range(31, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(31, 0)
					{
						...
						// celement: ypartial(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 7; i_0 += 1)
							{
								...
								// output_type_conversion : (ypartial_lv0_0_7_1[hls_map_index]).to_uint64()
								if (&(ypartial[0]) != NULL) // check the null address if the c port is array or others
								{
									ypartial[i_0] = (ypartial_lv0_0_7_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
	...
	else
	{
		...
		sc_bv<32>* ypartial_tvin_wrapc_buffer = new sc_bv<32>[8];
		...
		tcl_file.set_num(8, &tcl_file.ypartial_depth);
...
// [call_c_dut] ---------->
     ...
     if (aesl_tmp_4 > aesl_tmp_5)
     {
		...
		sc_bv<32>* ypartial_tvout_wrapc_buffer = new sc_bv<32>[8];
