...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "tiled_matvec.autotvin.dat"
	set constFileTvOut       "tiled_matvec.autotvout.dat"
	set constFileHdlTvIn     "tiled_matvec.autohdltvin.dat"
	set constFileHdlTvOut    "tiled_matvec.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
