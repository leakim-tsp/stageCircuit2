...
`define AUTOTB_TVIN_Atile_V_vec_0  "./c.tiled_matvec.autotvin_Atile_V_vec_0.dat"
`define AUTOTB_TVIN_Atile_V_vec_1  "./c.tiled_matvec.autotvin_Atile_V_vec_1.dat"
`define AUTOTB_TVIN_xtile_V_vec_0  "./c.tiled_matvec.autotvin_xtile_V_vec_0.dat"
`define AUTOTB_TVIN_xtile_V_vec_1  "./c.tiled_matvec.autotvin_xtile_V_vec_1.dat"
`define AUTOTB_TVIN_ypartial  "./c.tiled_matvec.autotvin_ypartial.dat"
`define AUTOTB_TVIN_i2  "./c.tiled_matvec.autotvin_i2.dat"
`define AUTOTB_TVIN_Atile_V_vec_0_out_wrapc  "./rtl.tiled_matvec.autotvin_Atile_V_vec_0.dat"
`define AUTOTB_TVIN_Atile_V_vec_1_out_wrapc  "./rtl.tiled_matvec.autotvin_Atile_V_vec_1.dat"
`define AUTOTB_TVIN_xtile_V_vec_0_out_wrapc  "./rtl.tiled_matvec.autotvin_xtile_V_vec_0.dat"
`define AUTOTB_TVIN_xtile_V_vec_1_out_wrapc  "./rtl.tiled_matvec.autotvin_xtile_V_vec_1.dat"
`define AUTOTB_TVIN_ypartial_out_wrapc  "./rtl.tiled_matvec.autotvin_ypartial.dat"
`define AUTOTB_TVIN_i2_out_wrapc  "./rtl.tiled_matvec.autotvin_i2.dat"
`define AUTOTB_TVOUT_ypartial  "./c.tiled_matvec.autotvout_ypartial.dat"
`define AUTOTB_TVOUT_ypartial_out_wrapc  "./impl_rtl.tiled_matvec.autotvout_ypartial.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.tiled_matvec.autotvout_ypartial.dat", "r");
    fp2 = $fopen("./impl_rtl.tiled_matvec.autotvout_ypartial.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.tiled_matvec.autotvout_ypartial.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.tiled_matvec.autotvout_ypartial.dat\"!");
    else begin
        $display("Comparing rtl.tiled_matvec.autotvout_ypartial.dat with impl_rtl.tiled_matvec.autotvout_ypartial.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
initial begin : proc_gen_xtile_V_vec_1_internal_ready
    ...
    `define STREAM_SIZE_IN_Atile_V_vec_0 "./stream_size_in_Atile_V_vec_0.dat"
    ...
    `define STREAM_SIZE_IN_Atile_V_vec_1 "./stream_size_in_Atile_V_vec_1.dat"
    ...
    `define STREAM_SIZE_IN_xtile_V_vec_0 "./stream_size_in_xtile_V_vec_0.dat"
    ...
    `define STREAM_SIZE_IN_xtile_V_vec_1 "./stream_size_in_xtile_V_vec_1.dat"
