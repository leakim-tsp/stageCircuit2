...
if {[file isfile tiled_matvec.autotvin.dat]} {
	file delete -force tiled_matvec.autotvin.dat
}

if {[file isfile tiled_matvec.autotvout.dat]} {
	file delete -force tiled_matvec.autotvout.dat
}
