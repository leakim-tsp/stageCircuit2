...
set C_modelArgList {
	{ y int 32 regular {array 2 { 2 0 } 1 1 }  }
	{ A int 32 regular {array 4 { 1 1 } 1 1 } {global 0}  }
	{ x int 32 regular {array 2 { 1 1 } 1 1 } {global 0}  }
}
...
set portList { 
	...
	{ y_address1 sc_out sc_lv 1 signal 0 } 
	...
	{ x_address1 sc_out sc_lv 1 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "y_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "y", "role": "address1" }} , 
 	...
 	{ "name": "x_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "x", "role": "address1" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "A", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0"},
...
set Spec2ImplPortList { 
	y { ap_memory {  { y_address0 mem_address 1 1 }  { y_ce0 mem_ce 1 1 }  { y_we0 mem_we 1 1 }  { y_d0 mem_din 1 32 }  { y_q0 mem_dout 0 32 }  { y_address1 MemPortADDR2 1 1 }  { y_ce1 MemPortCE2 1 1 }  { y_we1 MemPortWE2 1 1 }  { y_d1 MemPortDIN2 1 32 } } }
	...
	x { ap_memory {  { x_address0 mem_address 1 1 }  { x_ce0 mem_ce 1 1 }  { x_q0 mem_dout 0 32 }  { x_address1 MemPortADDR2 1 1 }  { x_ce1 MemPortCE2 1 1 }  { x_q1 MemPortDOUT2 0 32 } } }
}
