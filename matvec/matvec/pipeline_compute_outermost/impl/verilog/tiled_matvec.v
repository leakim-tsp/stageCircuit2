...
(* CORE_GENERATION_INFO="tiled_matvec,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7vx485t-ffg1157-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.035000,HLS_SYN_LAT=19,HLS_SYN_TPT=12,HLS_SYN_MEM=2,HLS_SYN_DSP=6,HLS_SYN_FF=460,HLS_SYN_LUT=1019,HLS_VERSION=2019_2}" *)
...
wire   [31:0] y_i_q0;
wire   [31:0] y_t_q0;
wire    tiled_matvec_entry4_U0_ap_start;
wire    tiled_matvec_entry4_U0_ap_done;
wire    tiled_matvec_entry4_U0_ap_continue;
wire    tiled_matvec_entry4_U0_ap_idle;
wire    tiled_matvec_entry4_U0_ap_ready;
wire    tiled_matvec_entry4_U0_start_out;
wire    tiled_matvec_entry4_U0_start_write;
wire   [31:0] tiled_matvec_entry4_U0_i2_out_din;
wire    tiled_matvec_entry4_U0_i2_out_write;
...
wire   [1:0] Loop_1_proc10_U0_A_address0;
wire    Loop_1_proc10_U0_A_ce0;
wire    Loop_1_proc10_U0_A_we0;
wire   [31:0] Loop_1_proc10_U0_A_d0;
wire    ap_channel_done_A;
wire    Loop_1_proc10_U0_A_full_n;
...
wire   [0:0] Loop_memset_y_proc_U0_y_address1;
wire    Loop_memset_y_proc_U0_y_ce1;
wire    Loop_memset_y_proc_U0_y_we1;
wire   [31:0] Loop_memset_y_proc_U0_y_d1;
wire   [1:0] Loop_memset_y_proc_U0_A_address0;
wire    Loop_memset_y_proc_U0_A_ce0;
wire   [1:0] Loop_memset_y_proc_U0_A_address1;
wire    Loop_memset_y_proc_U0_A_ce1;
wire   [0:0] Loop_memset_y_proc_U0_x_address0;
wire    Loop_memset_y_proc_U0_x_ce0;
wire   [0:0] Loop_memset_y_proc_U0_x_address1;
wire    Loop_memset_y_proc_U0_x_ce1;
...
wire    ap_sync_done;
wire    ap_sync_ready;
reg    ap_sync_reg_tiled_matvec_entry4_U0_ap_ready;
wire    ap_sync_tiled_matvec_entry4_U0_ap_ready;
reg   [1:0] tiled_matvec_entry4_U0_ap_ready_count;
...
initial begin
#0 ap_sync_reg_tiled_matvec_entry4_U0_ap_ready = 1'b0;
#0 tiled_matvec_entry4_U0_ap_ready_count = 2'd0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_tiled_matvec_entry4_U0_ap_ready <= 1'b0;
    end else begin
        if (((ap_sync_ready & ap_start) == 1'b1)) begin
            ap_sync_reg_tiled_matvec_entry4_U0_ap_ready <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (((tiled_matvec_entry4_U0_ap_ready == 1'b0) & (ap_sync_ready == 1'b1))) begin
        tiled_matvec_entry4_U0_ap_ready_count <= (tiled_matvec_entry4_U0_ap_ready_count - 2'd1);
    end else if (((ap_sync_ready == 1'b0) & (tiled_matvec_entry4_U0_ap_ready == 1'b1))) begin
        tiled_matvec_entry4_U0_ap_ready_count <= (tiled_matvec_entry4_U0_ap_ready_count + 2'd1);
    end
end
...
assign Loop_1_proc10_U0_A_full_n = A_i_full_n;

assign Loop_1_proc10_U0_ap_continue = A_i_full_n;
...
assign Loop_memset_y_proc_U0_ap_start = (x_t_empty_n & A_t_empty_n);
...
assign ap_channel_done_A = Loop_1_proc10_U0_ap_done;
...
assign ap_idle = (tiled_matvec_entry4_U0_ap_idle & tiled_matvec_entry12_U0_ap_idle & (y_t_empty_n ^ 1'b1) & (x_t_empty_n ^ 1'b1) & (1'b1 ^ A_t_empty_n) & Loop_memset_y_proc_U0_ap_idle & Loop_5_proc_U0_ap_idle & Loop_1_proc10_U0_ap_idle & Block_tiled_matvec_U0_ap_idle);
...
assign ap_sync_ready = (ap_sync_tiled_matvec_entry4_U0_ap_ready & ap_sync_Loop_5_proc_U0_ap_ready & ap_sync_Loop_1_proc10_U0_ap_ready & ap_sync_Block_tiled_matvec_U0_ap_ready);

assign ap_sync_tiled_matvec_entry4_U0_ap_ready = (tiled_matvec_entry4_U0_ap_ready | ap_sync_reg_tiled_matvec_entry4_U0_ap_ready);
...
assign tiled_matvec_entry4_U0_ap_continue = 1'b1;

assign tiled_matvec_entry4_U0_ap_start = ((ap_sync_reg_tiled_matvec_entry4_U0_ap_ready ^ 1'b1) & ap_start);
