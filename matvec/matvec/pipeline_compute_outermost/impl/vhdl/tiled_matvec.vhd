...
architecture behav of tiled_matvec is 
    ...
    "tiled_matvec,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7vx485t-ffg1157-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.035000,HLS_SYN_LAT=19,HLS_SYN_TPT=12,HLS_SYN_MEM=2,HLS_SYN_DSP=6,HLS_SYN_FF=460,HLS_SYN_LUT=1019,HLS_VERSION=2019_2}";
    ...
    signal tiled_matvec_entry4_U0_ap_start : STD_LOGIC;
    signal tiled_matvec_entry4_U0_ap_done : STD_LOGIC;
    signal tiled_matvec_entry4_U0_ap_continue : STD_LOGIC;
    signal tiled_matvec_entry4_U0_ap_idle : STD_LOGIC;
    signal tiled_matvec_entry4_U0_ap_ready : STD_LOGIC;
    signal tiled_matvec_entry4_U0_start_out : STD_LOGIC;
    signal tiled_matvec_entry4_U0_start_write : STD_LOGIC;
    signal tiled_matvec_entry4_U0_i2_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal tiled_matvec_entry4_U0_i2_out_write : STD_LOGIC;
    ...
    signal Loop_1_proc10_U0_A_address0 : STD_LOGIC_VECTOR (1 downto 0);
    signal Loop_1_proc10_U0_A_ce0 : STD_LOGIC;
    signal Loop_1_proc10_U0_A_we0 : STD_LOGIC;
    signal Loop_1_proc10_U0_A_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_channel_done_A : STD_LOGIC;
    signal Loop_1_proc10_U0_A_full_n : STD_LOGIC;
    ...
    signal Loop_memset_y_proc_U0_y_address1 : STD_LOGIC_VECTOR (0 downto 0);
    signal Loop_memset_y_proc_U0_y_ce1 : STD_LOGIC;
    signal Loop_memset_y_proc_U0_y_we1 : STD_LOGIC;
    signal Loop_memset_y_proc_U0_y_d1 : STD_LOGIC_VECTOR (31 downto 0);
    signal Loop_memset_y_proc_U0_A_address0 : STD_LOGIC_VECTOR (1 downto 0);
    signal Loop_memset_y_proc_U0_A_ce0 : STD_LOGIC;
    signal Loop_memset_y_proc_U0_A_address1 : STD_LOGIC_VECTOR (1 downto 0);
    signal Loop_memset_y_proc_U0_A_ce1 : STD_LOGIC;
    signal Loop_memset_y_proc_U0_x_address0 : STD_LOGIC_VECTOR (0 downto 0);
    signal Loop_memset_y_proc_U0_x_ce0 : STD_LOGIC;
    signal Loop_memset_y_proc_U0_x_address1 : STD_LOGIC_VECTOR (0 downto 0);
    signal Loop_memset_y_proc_U0_x_ce1 : STD_LOGIC;
    ...
    signal A_t_q1 : STD_LOGIC_VECTOR (31 downto 0);
    signal A_i_full_n : STD_LOGIC;
    signal A_t_empty_n : STD_LOGIC;
    signal A_t_d1 : STD_LOGIC_VECTOR (31 downto 0);
    signal A_t_we1 : STD_LOGIC;
    ...
    signal x_t_d1 : STD_LOGIC_VECTOR (31 downto 0);
    signal x_t_we1 : STD_LOGIC;
    ...
    signal ap_sync_reg_tiled_matvec_entry4_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_tiled_matvec_entry4_U0_ap_ready : STD_LOGIC;
    signal tiled_matvec_entry4_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    ...
    component tiled_matvec_entry4 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    ...
    port map (
        ...
        i_q0 => y_i_q0,
        i_address1 => Loop_memset_y_proc_U0_y_address1,
        i_ce1 => Loop_memset_y_proc_U0_y_ce1,
        i_we1 => Loop_memset_y_proc_U0_y_we1,
        i_d1 => Loop_memset_y_proc_U0_y_d1,
        t_address0 => Loop_5_proc_U0_y_address0,
        t_ce0 => Loop_5_proc_U0_y_ce0,
        t_we0 => ap_const_logic_0,
        t_d0 => ap_const_lv32_0,
        t_q0 => y_t_q0,
        t_address1 => ap_const_lv1_0,
    ...
    tiled_matvec_entry4_U0 : component tiled_matvec_entry4
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => tiled_matvec_entry4_U0_ap_start,
        start_full_n => start_for_tiled_matvec_entry12_U0_full_n,
        ap_done => tiled_matvec_entry4_U0_ap_done,
        ap_continue => tiled_matvec_entry4_U0_ap_continue,
        ap_idle => tiled_matvec_entry4_U0_ap_idle,
        ap_ready => tiled_matvec_entry4_U0_ap_ready,
        start_out => tiled_matvec_entry4_U0_start_out,
        start_write => tiled_matvec_entry4_U0_start_write,
        i2 => i2,
        i2_out_din => tiled_matvec_entry4_U0_i2_out_din,
        i2_out_full_n => i2_c1_full_n,
        i2_out_write => tiled_matvec_entry4_U0_i2_out_write);
    ...
    port map (
        ...
        A_address0 => Loop_1_proc10_U0_A_address0,
        A_ce0 => Loop_1_proc10_U0_A_ce0,
        A_we0 => Loop_1_proc10_U0_A_we0,
        A_d0 => Loop_1_proc10_U0_A_d0);
    ...
    port map (
        ...
        y_q0 => y_i_q0,
        y_address1 => Loop_memset_y_proc_U0_y_address1,
        y_ce1 => Loop_memset_y_proc_U0_y_ce1,
        y_we1 => Loop_memset_y_proc_U0_y_we1,
        y_d1 => Loop_memset_y_proc_U0_y_d1,
        A_address0 => Loop_memset_y_proc_U0_A_address0,
        A_ce0 => Loop_memset_y_proc_U0_A_ce0,
        A_q0 => A_t_q0,
        A_address1 => Loop_memset_y_proc_U0_A_address1,
        A_ce1 => Loop_memset_y_proc_U0_A_ce1,
        A_q1 => A_t_q1,
        x_address0 => Loop_memset_y_proc_U0_x_address0,
        x_ce0 => Loop_memset_y_proc_U0_x_ce0,
        x_q0 => x_t_q0,
        x_address1 => Loop_memset_y_proc_U0_x_address1,
        x_ce1 => Loop_memset_y_proc_U0_x_ce1,
        x_q1 => x_t_q1);
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        i_address0 => Loop_1_proc10_U0_A_address0,
        i_ce0 => Loop_1_proc10_U0_A_ce0,
        i_we0 => Loop_1_proc10_U0_A_we0,
        i_d0 => Loop_1_proc10_U0_A_d0,
        i_q0 => A_i_q0,
        i_address1 => ap_const_lv2_0,
        i_ce1 => ap_const_logic_0,
        i_q1 => A_i_q1,
        t_address0 => Loop_memset_y_proc_U0_A_address0,
        t_ce0 => Loop_memset_y_proc_U0_A_ce0,
        t_we0 => ap_const_logic_0,
        t_d0 => ap_const_lv32_0,
        t_q0 => A_t_q0,
        t_address1 => Loop_memset_y_proc_U0_A_address1,
        t_ce1 => Loop_memset_y_proc_U0_A_ce1,
        t_q1 => A_t_q1,
        i_ce => ap_const_logic_1,
        t_ce => ap_const_logic_1,
        i_full_n => A_i_full_n,
        i_write => Loop_1_proc10_U0_ap_done,
        t_empty_n => A_t_empty_n,
    ...
    port map (
        ...
        t_d0 => ap_const_lv32_0,
        t_q0 => x_t_q0,
        t_address1 => Loop_memset_y_proc_U0_x_address1,
        t_ce1 => Loop_memset_y_proc_U0_x_ce1,
        t_q1 => x_t_q1,
        i_ce => ap_const_logic_1,
        t_ce => ap_const_logic_1,
        i_full_n => x_i_full_n,
    ...
    port map (
        ...
        if_din => tiled_matvec_entry4_U0_i2_out_din,
        if_full_n => i2_c1_full_n,
        if_write => tiled_matvec_entry4_U0_i2_out_write,
        if_dout => i2_c1_dout,
    ...
    port map (
        ...
        if_write => tiled_matvec_entry4_U0_start_write,
    ...
    ap_sync_reg_tiled_matvec_entry4_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ...
                    ap_sync_reg_tiled_matvec_entry4_U0_ap_ready <= ap_sync_tiled_matvec_entry4_U0_ap_ready;
                end if; 
            end if;
        end if;
    end process;
    ...
    tiled_matvec_entry4_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tiled_matvec_entry4_U0_ap_ready = ap_const_logic_0) and (ap_sync_ready = ap_const_logic_1))) then 
                tiled_matvec_entry4_U0_ap_ready_count <= std_logic_vector(unsigned(tiled_matvec_entry4_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_sync_ready = ap_const_logic_0) and (tiled_matvec_entry4_U0_ap_ready = ap_const_logic_1))) then 
                tiled_matvec_entry4_U0_ap_ready_count <= std_logic_vector(unsigned(tiled_matvec_entry4_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    Loop_1_proc10_U0_A_full_n <= A_i_full_n;
    Loop_1_proc10_U0_ap_continue <= A_i_full_n;
    ...
    Loop_memset_y_proc_U0_ap_start <= (x_t_empty_n and A_t_empty_n);
    ...
    ap_channel_done_A <= Loop_1_proc10_U0_ap_done;
    ap_channel_done_x <= Block_tiled_matvec_U0_ap_done;
    ap_channel_done_y <= Loop_memset_y_proc_U0_ap_done;
    ap_done <= Loop_5_proc_U0_ap_done;
    ap_idle <= (tiled_matvec_entry4_U0_ap_idle and tiled_matvec_entry12_U0_ap_idle and (y_t_empty_n xor ap_const_logic_1) and (x_t_empty_n xor ap_const_logic_1) and (ap_const_logic_1 xor A_t_empty_n) and Loop_memset_y_proc_U0_ap_idle and Loop_5_proc_U0_ap_idle and Loop_1_proc10_U0_ap_idle and Block_tiled_matvec_U0_ap_idle);
    ...
    ap_sync_ready <= (ap_sync_tiled_matvec_entry4_U0_ap_ready and ap_sync_Loop_5_proc_U0_ap_ready and ap_sync_Loop_1_proc10_U0_ap_ready and ap_sync_Block_tiled_matvec_U0_ap_ready);
    ap_sync_tiled_matvec_entry4_U0_ap_ready <= (tiled_matvec_entry4_U0_ap_ready or ap_sync_reg_tiled_matvec_entry4_U0_ap_ready);
    ...
    tiled_matvec_entry4_U0_ap_start <= ((ap_sync_reg_tiled_matvec_entry4_U0_ap_ready xor ap_const_logic_1) and ap_start);
