...
tiled_matvec::tiled_matvec(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    y_U->i_q0(y_i_q0);
    y_U->i_address1(Loop_memset_y_proc_U0_y_address1);
    y_U->i_ce1(Loop_memset_y_proc_U0_y_ce1);
    y_U->i_we1(Loop_memset_y_proc_U0_y_we1);
    y_U->i_d1(Loop_memset_y_proc_U0_y_d1);
    ...
    y_U->t_q0(y_t_q0);
    y_U->t_address1(ap_var_for_const2);
    y_U->t_ce1(ap_var_for_const0);
    y_U->t_we1(ap_var_for_const0);
    y_U->t_d1(ap_var_for_const1);
    y_U->i_ce(ap_var_for_const3);
    y_U->t_ce(ap_var_for_const3);
    ...
    tiled_matvec_entry4_U0 = new tiled_matvec_entry4("tiled_matvec_entry4_U0");
    tiled_matvec_entry4_U0->ap_clk(ap_clk);
    tiled_matvec_entry4_U0->ap_rst(ap_rst);
    tiled_matvec_entry4_U0->ap_start(tiled_matvec_entry4_U0_ap_start);
    tiled_matvec_entry4_U0->start_full_n(start_for_tiled_matvec_entry12_U0_full_n);
    tiled_matvec_entry4_U0->ap_done(tiled_matvec_entry4_U0_ap_done);
    tiled_matvec_entry4_U0->ap_continue(tiled_matvec_entry4_U0_ap_continue);
    tiled_matvec_entry4_U0->ap_idle(tiled_matvec_entry4_U0_ap_idle);
    tiled_matvec_entry4_U0->ap_ready(tiled_matvec_entry4_U0_ap_ready);
    tiled_matvec_entry4_U0->start_out(tiled_matvec_entry4_U0_start_out);
    tiled_matvec_entry4_U0->start_write(tiled_matvec_entry4_U0_start_write);
    tiled_matvec_entry4_U0->i2(i2);
    tiled_matvec_entry4_U0->i2_out_din(tiled_matvec_entry4_U0_i2_out_din);
    tiled_matvec_entry4_U0->i2_out_full_n(i2_c1_full_n);
    tiled_matvec_entry4_U0->i2_out_write(tiled_matvec_entry4_U0_i2_out_write);
    ...
    Loop_1_proc10_U0->A_address0(Loop_1_proc10_U0_A_address0);
    Loop_1_proc10_U0->A_ce0(Loop_1_proc10_U0_A_ce0);
    Loop_1_proc10_U0->A_we0(Loop_1_proc10_U0_A_we0);
    Loop_1_proc10_U0->A_d0(Loop_1_proc10_U0_A_d0);
    ...
    Loop_memset_y_proc_U0->y_address1(Loop_memset_y_proc_U0_y_address1);
    Loop_memset_y_proc_U0->y_ce1(Loop_memset_y_proc_U0_y_ce1);
    Loop_memset_y_proc_U0->y_we1(Loop_memset_y_proc_U0_y_we1);
    Loop_memset_y_proc_U0->y_d1(Loop_memset_y_proc_U0_y_d1);
    Loop_memset_y_proc_U0->A_address0(Loop_memset_y_proc_U0_A_address0);
    Loop_memset_y_proc_U0->A_ce0(Loop_memset_y_proc_U0_A_ce0);
    Loop_memset_y_proc_U0->A_q0(A_t_q0);
    Loop_memset_y_proc_U0->A_address1(Loop_memset_y_proc_U0_A_address1);
    Loop_memset_y_proc_U0->A_ce1(Loop_memset_y_proc_U0_A_ce1);
    Loop_memset_y_proc_U0->A_q1(A_t_q1);
    ...
    Loop_memset_y_proc_U0->x_address1(Loop_memset_y_proc_U0_x_address1);
    Loop_memset_y_proc_U0->x_ce1(Loop_memset_y_proc_U0_x_ce1);
    Loop_memset_y_proc_U0->x_q1(x_t_q1);
    ...
    A_U = new tiled_matvec_A("A_U");
    A_U->clk(ap_clk);
    A_U->reset(ap_rst);
    A_U->i_address0(Loop_1_proc10_U0_A_address0);
    A_U->i_ce0(Loop_1_proc10_U0_A_ce0);
    A_U->i_we0(Loop_1_proc10_U0_A_we0);
    A_U->i_d0(Loop_1_proc10_U0_A_d0);
    A_U->i_q0(A_i_q0);
    A_U->i_address1(ap_var_for_const4);
    A_U->i_ce1(ap_var_for_const0);
    A_U->i_q1(A_i_q1);
    A_U->t_address0(Loop_memset_y_proc_U0_A_address0);
    A_U->t_ce0(Loop_memset_y_proc_U0_A_ce0);
    A_U->t_we0(ap_var_for_const0);
    A_U->t_d0(ap_var_for_const1);
    A_U->t_q0(A_t_q0);
    A_U->t_address1(Loop_memset_y_proc_U0_A_address1);
    A_U->t_ce1(Loop_memset_y_proc_U0_A_ce1);
    A_U->t_q1(A_t_q1);
    A_U->i_ce(ap_var_for_const3);
    A_U->t_ce(ap_var_for_const3);
    A_U->i_full_n(A_i_full_n);
    A_U->i_write(Loop_1_proc10_U0_ap_done);
    A_U->t_empty_n(A_t_empty_n);
    A_U->t_read(Loop_memset_y_proc_U0_ap_ready);
    ...
    x_U->i_q0(x_i_q0);
    x_U->i_address1(ap_var_for_const2);
    x_U->i_ce1(ap_var_for_const0);
    x_U->i_q1(x_i_q1);
    ...
    x_U->t_q0(x_t_q0);
    x_U->t_address1(Loop_memset_y_proc_U0_x_address1);
    x_U->t_ce1(Loop_memset_y_proc_U0_x_ce1);
    x_U->t_q1(x_t_q1);
    x_U->i_ce(ap_var_for_const3);
    x_U->t_ce(ap_var_for_const3);
    ...
    i2_c1_U->if_read_ce(ap_var_for_const3);
    i2_c1_U->if_write_ce(ap_var_for_const3);
    i2_c1_U->if_din(tiled_matvec_entry4_U0_i2_out_din);
    i2_c1_U->if_full_n(i2_c1_full_n);
    i2_c1_U->if_write(tiled_matvec_entry4_U0_i2_out_write);
    ...
    i2_c_U->clk(ap_clk);
    i2_c_U->reset(ap_rst);
    i2_c_U->if_read_ce(ap_var_for_const3);
    i2_c_U->if_write_ce(ap_var_for_const3);
    ...
    i2_load_loc_c_U->if_read_ce(ap_var_for_const3);
    i2_load_loc_c_U->if_write_ce(ap_var_for_const3);
    ...
    start_for_tiled_mbkb_U->if_read_ce(ap_var_for_const3);
    start_for_tiled_mbkb_U->if_write_ce(ap_var_for_const3);
    ...
    start_for_tiled_mbkb_U->if_write(tiled_matvec_entry4_U0_start_write);
    ...
    SC_METHOD(thread_A_t_d1);

    SC_METHOD(thread_A_t_we1);
    ...
    SC_METHOD(thread_Loop_1_proc10_U0_A_full_n);
    sensitive << ( A_i_full_n );
    ...
    SC_METHOD(thread_ap_channel_done_A);
    sensitive << ( Loop_1_proc10_U0_ap_done );
    ...
    sensitive << ( tiled_matvec_entry4_U0_ap_idle );
    ...
    sensitive << ( ap_sync_tiled_matvec_entry4_U0_ap_ready );
    ...
    SC_METHOD(thread_ap_sync_tiled_matvec_entry4_U0_ap_ready);
    sensitive << ( tiled_matvec_entry4_U0_ap_ready );
    sensitive << ( ap_sync_reg_tiled_matvec_entry4_U0_ap_ready );
    ...
    SC_METHOD(thread_tiled_matvec_entry4_U0_ap_continue);

    SC_METHOD(thread_tiled_matvec_entry4_U0_ap_start);
    sensitive << ( ap_start );
    sensitive << ( ap_sync_reg_tiled_matvec_entry4_U0_ap_ready );

    SC_METHOD(thread_x_t_d1);

    SC_METHOD(thread_x_t_we1);
    ...
    ap_sync_reg_tiled_matvec_entry4_U0_ap_ready = SC_LOGIC_0;
    tiled_matvec_entry4_U0_ap_ready_count = "00";
    ...
    sc_trace(mVcdFile, tiled_matvec_entry4_U0_ap_start, "tiled_matvec_entry4_U0_ap_start");
    sc_trace(mVcdFile, tiled_matvec_entry4_U0_ap_done, "tiled_matvec_entry4_U0_ap_done");
    sc_trace(mVcdFile, tiled_matvec_entry4_U0_ap_continue, "tiled_matvec_entry4_U0_ap_continue");
    sc_trace(mVcdFile, tiled_matvec_entry4_U0_ap_idle, "tiled_matvec_entry4_U0_ap_idle");
    sc_trace(mVcdFile, tiled_matvec_entry4_U0_ap_ready, "tiled_matvec_entry4_U0_ap_ready");
    sc_trace(mVcdFile, tiled_matvec_entry4_U0_start_out, "tiled_matvec_entry4_U0_start_out");
    sc_trace(mVcdFile, tiled_matvec_entry4_U0_start_write, "tiled_matvec_entry4_U0_start_write");
    sc_trace(mVcdFile, tiled_matvec_entry4_U0_i2_out_din, "tiled_matvec_entry4_U0_i2_out_din");
    sc_trace(mVcdFile, tiled_matvec_entry4_U0_i2_out_write, "tiled_matvec_entry4_U0_i2_out_write");
    ...
    sc_trace(mVcdFile, Loop_1_proc10_U0_A_address0, "Loop_1_proc10_U0_A_address0");
    sc_trace(mVcdFile, Loop_1_proc10_U0_A_ce0, "Loop_1_proc10_U0_A_ce0");
    sc_trace(mVcdFile, Loop_1_proc10_U0_A_we0, "Loop_1_proc10_U0_A_we0");
    sc_trace(mVcdFile, Loop_1_proc10_U0_A_d0, "Loop_1_proc10_U0_A_d0");
    sc_trace(mVcdFile, ap_channel_done_A, "ap_channel_done_A");
    sc_trace(mVcdFile, Loop_1_proc10_U0_A_full_n, "Loop_1_proc10_U0_A_full_n");
    ...
    sc_trace(mVcdFile, Loop_memset_y_proc_U0_y_address1, "Loop_memset_y_proc_U0_y_address1");
    sc_trace(mVcdFile, Loop_memset_y_proc_U0_y_ce1, "Loop_memset_y_proc_U0_y_ce1");
    sc_trace(mVcdFile, Loop_memset_y_proc_U0_y_we1, "Loop_memset_y_proc_U0_y_we1");
    sc_trace(mVcdFile, Loop_memset_y_proc_U0_y_d1, "Loop_memset_y_proc_U0_y_d1");
    sc_trace(mVcdFile, Loop_memset_y_proc_U0_A_address0, "Loop_memset_y_proc_U0_A_address0");
    sc_trace(mVcdFile, Loop_memset_y_proc_U0_A_ce0, "Loop_memset_y_proc_U0_A_ce0");
    sc_trace(mVcdFile, Loop_memset_y_proc_U0_A_address1, "Loop_memset_y_proc_U0_A_address1");
    sc_trace(mVcdFile, Loop_memset_y_proc_U0_A_ce1, "Loop_memset_y_proc_U0_A_ce1");
    ...
    sc_trace(mVcdFile, Loop_memset_y_proc_U0_x_address1, "Loop_memset_y_proc_U0_x_address1");
    sc_trace(mVcdFile, Loop_memset_y_proc_U0_x_ce1, "Loop_memset_y_proc_U0_x_ce1");
    ...
    sc_trace(mVcdFile, A_t_q0, "A_t_q0");
    sc_trace(mVcdFile, A_t_q1, "A_t_q1");
    sc_trace(mVcdFile, A_i_full_n, "A_i_full_n");
    sc_trace(mVcdFile, A_t_empty_n, "A_t_empty_n");
    sc_trace(mVcdFile, A_t_d1, "A_t_d1");
    sc_trace(mVcdFile, A_t_we1, "A_t_we1");
    sc_trace(mVcdFile, x_i_q0, "x_i_q0");
    sc_trace(mVcdFile, x_i_q1, "x_i_q1");
    sc_trace(mVcdFile, x_t_q0, "x_t_q0");
    sc_trace(mVcdFile, x_t_q1, "x_t_q1");
    sc_trace(mVcdFile, x_i_full_n, "x_i_full_n");
    sc_trace(mVcdFile, x_t_empty_n, "x_t_empty_n");
    sc_trace(mVcdFile, x_t_d1, "x_t_d1");
    sc_trace(mVcdFile, x_t_we1, "x_t_we1");
    ...
    sc_trace(mVcdFile, ap_sync_reg_tiled_matvec_entry4_U0_ap_ready, "ap_sync_reg_tiled_matvec_entry4_U0_ap_ready");
    sc_trace(mVcdFile, ap_sync_tiled_matvec_entry4_U0_ap_ready, "ap_sync_tiled_matvec_entry4_U0_ap_ready");
    sc_trace(mVcdFile, tiled_matvec_entry4_U0_ap_ready_count, "tiled_matvec_entry4_U0_ap_ready_count");
...
void tiled_matvec::thread_ap_var_for_const3() {
...
void tiled_matvec::thread_ap_var_for_const4() {
...
void tiled_matvec::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ap_sync_reg_tiled_matvec_entry4_U0_ap_ready = ap_const_logic_0;
    } else {
        if (esl_seteq<1,1,1>(ap_const_logic_1, (ap_start.read() & 
             ap_sync_ready.read()))) {
            ap_sync_reg_tiled_matvec_entry4_U0_ap_ready = ap_const_logic_0;
        } else {
            ap_sync_reg_tiled_matvec_entry4_U0_ap_ready = ap_sync_tiled_matvec_entry4_U0_ap_ready.read();
        }
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_0, tiled_matvec_entry4_U0_ap_ready.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_sync_ready.read()))) {
        tiled_matvec_entry4_U0_ap_ready_count = (!tiled_matvec_entry4_U0_ap_ready_count.read().is_01() || !ap_const_lv2_1.is_01())? sc_lv<2>(): (sc_biguint<2>(tiled_matvec_entry4_U0_ap_ready_count.read()) - sc_biguint<2>(ap_const_lv2_1));
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, tiled_matvec_entry4_U0_ap_ready.read()) && 
                esl_seteq<1,1,1>(ap_const_logic_0, ap_sync_ready.read()))) {
        tiled_matvec_entry4_U0_ap_ready_count = (!tiled_matvec_entry4_U0_ap_ready_count.read().is_01() || !ap_const_lv2_1.is_01())? sc_lv<2>(): (sc_biguint<2>(tiled_matvec_entry4_U0_ap_ready_count.read()) + sc_biguint<2>(ap_const_lv2_1));
    }
}

void tiled_matvec::thread_A_t_d1() {
    A_t_d1 = ap_const_lv32_0;
}

void tiled_matvec::thread_A_t_we1() {
    A_t_we1 = ap_const_logic_0;
}
...
void tiled_matvec::thread_Loop_1_proc10_U0_A_full_n() {
    Loop_1_proc10_U0_A_full_n = A_i_full_n.read();
}

void tiled_matvec::thread_Loop_1_proc10_U0_ap_continue() {
    Loop_1_proc10_U0_ap_continue = A_i_full_n.read();
}
...
void tiled_matvec::thread_Loop_memset_y_proc_U0_ap_start() {
    Loop_memset_y_proc_U0_ap_start = (A_t_empty_n.read() & x_t_empty_n.read());
}
...
void tiled_matvec::thread_ap_channel_done_A() {
    ap_channel_done_A = Loop_1_proc10_U0_ap_done.read();
}
...
void tiled_matvec::thread_ap_idle() {
    ap_idle = (tiled_matvec_entry4_U0_ap_idle.read() & tiled_matvec_entry12_U0_ap_idle.read() & Loop_1_proc10_U0_ap_idle.read() & Block_tiled_matvec_U0_ap_idle.read() & Loop_memset_y_proc_U0_ap_idle.read() & Loop_5_proc_U0_ap_idle.read() & (A_t_empty_n.read() ^ 
  ap_const_logic_1) & (x_t_empty_n.read() ^ 
...
void tiled_matvec::thread_ap_sync_ready() {
    ap_sync_ready = (ap_sync_tiled_matvec_entry4_U0_ap_ready.read() & ap_sync_Loop_1_proc10_U0_ap_ready.read() & ap_sync_Block_tiled_matvec_U0_ap_ready.read() & ap_sync_Loop_5_proc_U0_ap_ready.read());
}

void tiled_matvec::thread_ap_sync_tiled_matvec_entry4_U0_ap_ready() {
    ap_sync_tiled_matvec_entry4_U0_ap_ready = (tiled_matvec_entry4_U0_ap_ready.read() | ap_sync_reg_tiled_matvec_entry4_U0_ap_ready.read());
}
...
void tiled_matvec::thread_tiled_matvec_entry4_U0_ap_continue() {
    tiled_matvec_entry4_U0_ap_continue = ap_const_logic_1;
}

void tiled_matvec::thread_tiled_matvec_entry4_U0_ap_start() {
    tiled_matvec_entry4_U0_ap_start = (ap_start.read() & (ap_sync_reg_tiled_matvec_entry4_U0_ap_ready.read() ^ 
  ap_const_logic_1));
}

void tiled_matvec::thread_x_t_d1() {
    x_t_d1 = ap_const_lv32_0;
}

void tiled_matvec::thread_x_t_we1() {
    x_t_we1 = ap_const_logic_0;
}
